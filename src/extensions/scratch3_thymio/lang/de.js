module.exports = {
    blocks: {
        ...
        setOdomoter: 'Kilometerzähler Richtung [N] x: [O] y: [P] einstellen',
        ...
        nextDial: 'schalten des nächsten Kreises LED [L] ein',
        ...
        stopSoundRecord: 'stop sound recording', // TODO: translate
        ...
        bump: 'wenn ein Schock erkannt wird',
        soundDetected: 'wenn ein Ton erkannt wird',
        valButton: '[B] Taste',
        proximity: 'horiz. [N] Näherungsschalter',
        proxHorizontal: 'alle horiz. Näherungsschalter anzeigen',
